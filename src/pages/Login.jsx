  ...
  return (
    <section className="h-screen grid place-items-center">
      <Form method="post" className="card w-96  p-8 bg-base-100 shadow-lg flex flex-col gap-y-4">
        ...
        <FormInput type="email" label="email" name="identifier" defaultValue="ol343@gmail.com" />
        <FormInput type="password" label="password" name="password" defaultValue="34568765434" />
        <div className="mt-4">
